...
### Prevent duplicate values {#prevent-duplicate-values}
...
## Use HTAP capabilities {#use-htap-capabilities}

<CustomContent platform="tidb">

> **Note:**
>
> The steps provided in this guide is ***ONLY*** for quick start in the test environment. For production environments, refer to [explore HTAP](/explore-htap.md).
...
> **Note:**
>
> The steps provided in this guide is ***ONLY*** for quick start. For more instructions, refer to [Use an HTAP Cluster with TiFlash](/tiflash/tiflash-overview.md).
...
### Replicate column-based data {#replicate-column-based-data}
...
### An example of using HTAP capabilities {#an-example-of-using-htap-capabilities}
...
## Execute the <code>CREATE TABLE</code> statement {#execute-the-code-create-table-code-statement}
...
## Guidelines to follow when creating a table {#guidelines-to-follow-when-creating-a-table}

This section provides guidelines you need to follow when creating a table.

### Guidelines to follow when naming a table {#guidelines-to-follow-when-naming-a-table}
...
### Guidelines to follow when defining columns {#guidelines-to-follow-when-defining-columns}
...
### Guidelines to follow when selecting primary key {#guidelines-to-follow-when-selecting-primary-key}
...
### Guidelines to follow when selecting clustered index {#guidelines-to-follow-when-selecting-clustered-index}
...
### Guidelines to follow when executing the <code>CREATE TABLE</code> statement {#guidelines-to-follow-when-executing-the-code-create-table-code-statement}
