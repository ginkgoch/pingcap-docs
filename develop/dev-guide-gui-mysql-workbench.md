...
# Connect to TiDB with MySQL Workbench {#connect-to-tidb-with-mysql-workbench}
...
### How to handle the connection timeout error "Error Code: 2013. Lost connection to MySQL server during query"? {#how-to-handle-the-connection-timeout-error-error-code-2013-lost-connection-to-mysql-server-during-query}
