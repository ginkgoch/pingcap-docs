...
# Connect to TiDB with TypeORM {#connect-to-tidb-with-typeorm}
...
### Step 5: Run the code and check the result {#step-5-run-the-code-and-check-the-result}
...
### Connect with connection options {#connect-with-connection-options}
...
### Execute raw SQL queries {#execute-raw-sql-queries}
