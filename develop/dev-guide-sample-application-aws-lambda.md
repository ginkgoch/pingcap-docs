...
## Deploy the AWS Lambda Function {#deploy-the-aws-lambda-function}
...
### SAM CLI deployment (Recommended) {#sam-cli-deployment-recommended}
...
### Web console deployment {#web-console-deployment}
