...
# Connect to TiDB with Rails Framework and ActiveRecord ORM {#connect-to-tidb-with-rails-framework-and-activerecord-orm}
...
### Connect to TiDB with connection options {#connect-to-tidb-with-connection-options}
