...
1.  Navigate to the [**Clusters**](https://%7B%7B%7B.console-url%7D%7D%7D/project/clusters) page, and then click the name of your target cluster to go to its overview page.
