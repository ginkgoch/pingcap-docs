...
## Enable console audit logging {#enable-console-audit-logging}
...
## Disable console audit logging {#disable-console-audit-logging}
...
## View console audit logs {#view-console-audit-logs}
...
## Export console audit logs {#export-console-audit-logs}
...
## Console audit log storage policy {#console-audit-log-storage-policy}
...
## Console audit event types {#console-audit-event-types}
...
## Console audit log fields {#console-audit-log-fields}
