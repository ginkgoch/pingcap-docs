...
# Full-Text Search with SQL {#full-text-search-with-sql}
...
### Create a full-text index {#create-a-full-text-index}
...
## Advanced example: Join search results with other tables {#advanced-example-join-search-results-with-other-tables}
