...
# Use SQL User Resource {#use-sql-user-resource}
...
## Create a SQL user {#create-a-sql-user}
...
## Change the password or user roles of a SQL user {#change-the-password-or-user-roles-of-a-sql-user}
...
## Import a SQL user {#import-a-sql-user}
...
## Delete a SQL user {#delete-a-sql-user}
