...
# Configure External Storage Access for TiDB Cloud Dedicated {#configure-external-storage-access-for-tidb-cloud-dedicated}
...
### Configure Amazon S3 access using a Role ARN {#configure-amazon-s3-access-using-a-role-arn}
...
### Configure Amazon S3 access using an AWS access key {#configure-amazon-s3-access-using-an-aws-access-key}
...
## Configure Azure Blob Storage access {#configure-azure-blob-storage-access}
