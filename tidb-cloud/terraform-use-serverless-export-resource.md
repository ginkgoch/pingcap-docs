...
# Use TiDB Cloud Serverless Export Resource {#use-tidb-cloud-serverless-export-resource}
...
## Create a TiDB Cloud Serverless data export task {#create-a-tidb-cloud-serverless-data-export-task}
...
## Import a TiDB Cloud Serverless data export task {#import-a-tidb-cloud-serverless-data-export-task}
...
## Delete a TiDB Cloud Serverless data export task {#delete-a-tidb-cloud-serverless-data-export-task}
