...
## Step 3. Sign up and create a TiDB Cloud Dedicated cluster for the PoC {#step-3-sign-up-and-create-a-tidb-cloud-dedicated-cluster-for-the-poc}
...
### 3. How to make the best use of my PoC credits? {#3-how-to-make-the-best-use-of-my-poc-credits}
...
### 4. Can I take more than 2 weeks to complete a PoC? {#4-can-i-take-more-than-2-weeks-to-complete-a-poc}
