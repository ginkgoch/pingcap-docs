...
### Enable audit logging for Google Cloud {#enable-audit-logging-for-google-cloud}
...
### Enable audit logging for Azure {#enable-audit-logging-for-azure}

To enable audit logging for Azure, take the following steps:

#### Step 1. Create an Azure storage account {#step-1-create-an-azure-storage-account}
...
#### Step 2. Configure Azure Blob Storage access {#step-2-configure-azure-blob-storage-access}
