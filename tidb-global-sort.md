...
# TiDB Global Sort {#tidb-global-sort}
...
### Step 1: Scan and prepare data {#step-1-scan-and-prepare-data}
...
### Step 2: Sort and distribute data {#step-2-sort-and-distribute-data}
