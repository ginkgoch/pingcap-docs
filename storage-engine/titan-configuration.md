...
# Titan Configuration {#titan-configuration}
...
### <code>blob-file-compression</code> and <code>zstd-dict-size</code> {#code-blob-file-compression-code-and-code-zstd-dict-size-code}
...
### <code>discardable-ratio</code> and <code>max-background-gc</code> {#code-discardable-ratio-code-and-code-max-background-gc-code}
...
### Titan configuration example {#titan-configuration-example}
...
## Level Merge (experimental) {#level-merge-experimental}
