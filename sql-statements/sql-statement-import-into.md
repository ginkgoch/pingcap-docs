...
### <code>IMPORT INTO ... FROM FILE</code> restrictions {#code-import-into-from-file-code-restrictions}
...
### <code>IMPORT INTO ... FROM SELECT</code> restrictions {#code-import-into-from-select-code-restrictions}
...
## Prerequisites for import {#prerequisites-for-import}
...
## <code>IMPORT INTO ... FROM FILE</code> usage {#code-import-into-from-file-code-usage}
...
### View and manage import jobs {#view-and-manage-import-jobs}
...
#### Import a CSV file with headers {#import-a-csv-file-with-headers}

```sql
IMPORT INTO t FROM '/path/to/file.csv' WITH skip_rows=1;
```

#### Import a file asynchronously in the <code>DETACHED</code> mode {#import-a-file-asynchronously-in-the-code-detached-code-mode}

```sql
IMPORT INTO t FROM '/path/to/file.csv' WITH DETACHED;
```

#### Skip importing a specific field in your data file {#skip-importing-a-specific-field-in-your-data-file}
...
#### Import multiple data files using wildcards {#import-multiple-data-files-using-wildcards}
...
#### Import data files from Amazon S3 or GCS {#import-data-files-from-amazon-s3-or-gcs}
...
#### Calculate column values using SetClause {#calculate-column-values-using-setclause}
...
#### Import a data file in the SQL format {#import-a-data-file-in-the-sql-format}

```sql
IMPORT INTO t FROM '/path/to/file.sql' FORMAT 'sql';
```

#### Limit the write speed to TiKV {#limit-the-write-speed-to-tikv}
...
## <code>IMPORT INTO ... FROM SELECT</code> usage {#code-import-into-from-select-code-usage}
...
### Import the query result of <code>SELECT</code> {#import-the-query-result-of-code-select-code}
...
### Import historical data at a specified time point {#import-historical-data-at-a-specified-time-point}
