...
# TiDB Log Backup and PITR Guide {#tidb-log-backup-and-pitr-guide}
...
## Back up TiDB cluster {#back-up-tidb-cluster}

### Start log backup {#start-log-backup}
...
### Run full backup regularly {#run-full-backup-regularly}
...
## Performance capabilities of PITR {#performance-capabilities-of-pitr}
