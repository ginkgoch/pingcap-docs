...
# TiDB Log Backup and PITR Command Manual {#tidb-log-backup-and-pitr-command-manual}
...
### Start a backup task {#start-a-backup-task}
...
### Query the backup status {#query-the-backup-status}
...
### Pause and resume a backup task {#pause-and-resume-a-backup-task}
...
### Stop and restart a backup task {#stop-and-restart-a-backup-task}
...
#### Stop a backup task {#stop-a-backup-task}
...
#### Restart a backup task {#restart-a-backup-task}
...
### Clean up backup data {#clean-up-backup-data}
...
### View the backup metadata {#view-the-backup-metadata}
